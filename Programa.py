...
print("USO DE SETTERS")
objeto_carro.set_marca("Ford")
objeto_carro.set_modelo("Mustang")
objeto_carro.set_color("Rojo")
objeto_carro.set_kilometraje(500)
objeto_carro.set_gasolina(75)
print("Atributos actualizados con setters.")
print("")
